...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'inokori297@hd123.gq',
  ...
  protectedRoutes: ['/🌞 Private folder/u-need-a-password',/🥟Drama/Protected route'],
